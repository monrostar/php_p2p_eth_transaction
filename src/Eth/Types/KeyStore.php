...
class KeyStore
{
     ...
     * @throws Exception
     */
    static function save($privateKey, $password, $dir): string
    {
     ...
     * @throws Exception
     */
    static function load($password, $wallet): string
    {
     ...
     * @throws Exception
     */
    static function privateToAddress($priv_hex): string
    {
        $ec = new EC('secp256k1');
     ...
     * @return string
     */
    static function guidv4($data): string
    {
